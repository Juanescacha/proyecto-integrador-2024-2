...
export function Model(props) {
  const { nodes, materials } = useGLTF("/models/EscenaDeforestacion1.glb")
  return (
    <group {...props} dispose={null}>
      <group position={[1.805, 2.809, 6.033]} rotation={[0.039, 0.088, 0]} scale={1.447}>
        <mesh
          castShadow
          receiveShadow
      ...
      <group position={[5.716, 2.809, -5.122]} rotation={[2.363, 1.516, -2.361]} scale={1.447}>
        <mesh
          castShadow
          receiveShadow
      ...
      <group position={[56.684, 3.185, -43.297]} rotation={[3.1, 0.375, -3.123]} scale={2.159}>
        <mesh
          castShadow
          receiveShadow
      ...
      <mesh
        ...
        position={[32.16, 11.388, -35.712]}
        rotation={[-Math.PI, -0.881, -Math.PI / 2]}
        scale={[5.082, 7.689, 7.689]}
      />
    </group>
  )
}

useGLTF.preload("/models/EscenaDeforestacion1.glb")
